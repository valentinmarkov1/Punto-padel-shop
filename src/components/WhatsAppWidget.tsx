        ...
        <div className="fixed bottom-6 right-6 z-[100] flex flex-col items-end pointer-events-none" ref={chatRef}>
            ...
            >
                    ...
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center overflow-hidden">
                            <img
                                ...
                                onError={(e) => {
                                    (e.target as HTMLImageElement).src = 'https://api.dicebear.com/7.x/initials/svg?seed=PP';
                                }}
                            />
                        </div>
                ...
                <div className="p-4 bg-[#e5ddd5] max-h-[400px] overflow-y-auto">
                    <div className="bg-white rounded-lg p-3 mb-4 shadow-sm relative text-sm inline-block max-w-[80%] after:content-[''] after:absolute after:top-0 after:left-[-8px] after:border-[8px] after:border-transparent after:border-t-white">
                    ...
                    <div className="flex flex-col gap-2 mt-4">
                        {quickMessages.map((msg) => (
                            <button
                                ...
                                className="bg-white hover:bg-gray-50 text-gray-800 text-left p-3 rounded-xl border border-gray-200 transition-all text-sm font-medium shadow-sm active:scale-[0.98]"
                            >
                                {msg.text}
                            </button>
                        ))}
                ...
                <div className="p-3 bg-white border-t flex items-center gap-2">
                    <input
                        ...
                        className="flex-1 bg-gray-100 rounded-full px-4 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-[#25D366]"
                        value={message}
                    ...
                    <button
                        ...
                        className={cn(
                            ...
                            message.trim() ? "bg-[#25D366] text-white" : "bg-gray-200 text-gray-400"
                        )}
                    >
                        <Send size={20} />
                    </button>
            ...
            <button
                ...
                className={cn(
                    "w-16 h-16 rounded-full flex items-center justify-center shadow-2xl transition-all duration-300 pointer-events-auto transform hover:scale-110 active:scale-95",
                    isOpen ? "bg-white text-gray-500" : "bg-[#25D366] text-white animate-pulse-whatsapp"
                )}
            >
                {isOpen ? (
                    <X size={32} />
